...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\visophyte on
     Windows, /home/user/dev/visophyte on Linux) in a file named
     visophyte@visophyte.org and copy that file to
